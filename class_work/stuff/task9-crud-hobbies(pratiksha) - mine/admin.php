...
if(isset($_POST['login'])){
	...
	// }
	//if(isset($_POST['login'])){
    $checkemail = mysqli_fetch_assoc(mysqli_query($conn, "SELECT email FROM admins WHERE email='".$_POST['email']."'"));
    if(!empty($checkemail)){
        $checkepassword = mysqli_fetch_assoc(mysqli_query($conn, "SELECT email,password FROM admins WHERE email='". $_POST['email'] . "' and password='" . $_POST['password'] . "'"));
        if(!empty($checkepassword)){
            $checkstatus = mysqli_fetch_assoc(mysqli_query($conn, "SELECT status FROM admins WHERE status='Active'"));
