...
else
{
	if(isset($_POST['update']))
	{
		...
		if(empty($errors))
		{
			...
			{
				$updatehobby = "UPDATE countries SET 
					...
					<div class="panel-body">
						<?php 
							...
							{ ?>
								...
								//sleep(3);
								echo "<script>setTimeout(\"location.href = 'http://localhost/Php-Mysql/class_work/task9-crud-hobbies(harsh)/country_manage.php';\",1500);</script>";

								//header("location:country_manage.php"); ?></div>
							<?php } ?>
							<?php 
