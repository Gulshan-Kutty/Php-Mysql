<?php 
	...
	if(isset($_POST['deleteall']))
	{
		...
		else
		{
			...
			{
				// To fetch id of table hobbies against tokenid 
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form method="post">
					...
					<br />
					<button type="button"
						class="glyphicon glyphicon-plus btn btn-primary btn-sm col-md-1 col-md-push-11" name="create"
						onclick="window.location='user_create.php'">Create</button>
					<br />
					<br />
					<br />
					<div class="table-responsive">
						<table id="usersdatalist" class="table table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									<td><input type="checkbox" name="selector[]"
											value="<?= base64_encode($userrow['tokenid']) ;?>" /></td>
									<td>
										<?= empty($userrow['name'])?'--NA--':$userrow['name']; ?>
									</td>
									<td>
										<?= empty($userrow['email'])?'--NA--':$userrow['email']; ?>
									</td>
									<td>
									...
									<td>
										<a
											href="user_view.php?tokenid=<?= base64_encode($userrow['tokenid']) ;?>">view</a>

										<a href="user_update.php?tokenid=<?= base64_encode($userrow['tokenid']) ;?>"
											class="glyphicon glyphicon-pencil btn"></a>



										<a href="user_delete.php?tokenid=<?= base64_encode($userrow['tokenid']) ;?>"
							...
							<tr>
								<td colspan="4"><button type="submit" name="deleteall"
